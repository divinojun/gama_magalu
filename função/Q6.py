...
# Por exemplo, o programa deve converter 14:25 em 2:25 P.M. A entrada é dada 
# em dois inteiros. Deve haver pelo menos duas funções: uma para fazer a 
...
while True:
    ...
    if hora == 999 and minunto == 999:
        break
    minunto = int(input('Digite os minutos >: '))
    converter(hora, minunto)
